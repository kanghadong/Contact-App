      ...
      <ScrollView style={styles.container}>
        ...
        <Card style={styles.actionContainer}>
          <CardItem bordered style={styles.actionButton}>
            ...
            >
             <Icon name='text' style={{fontSize: 40, color: '#B83227'}}/>
            </TouchableOpacity>
          </CardItem>
          <CardItem bordered style={styles.actionButton}>
            <TouchableOpacity
            ...
            >
             <Icon name='call' style={{fontSize: 40, color: '#B83227'}}/>
            </TouchableOpacity>
          </CardItem>
        </Card>
        <Card style={styles.actionContainer}>
          <CardItem bordered style={styles.actionButton}>
            ...
            >
             <Icon name='create' style={{fontSize: 40, color: '#B83227'}}/>
            </TouchableOpacity>
          </CardItem>
          <CardItem bordered style={styles.actionButton}>
            <TouchableOpacity
            ...
            >
             <Icon name='trash' style={{fontSize: 40, color: '#B83227'}}/>
            </TouchableOpacity>
          </CardItem>
        </Card>
      </ScrollView>
